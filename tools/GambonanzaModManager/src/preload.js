...
contextBridge.exposeInMainWorld('gambonanza', {
  ...
  packPreview: invoke('texturepacks:packPreview'),
  pickPackImage: invoke('texturepacks:pickImage'),
  setPackImage: invoke('texturepacks:setImage'),
  removePackImage: invoke('texturepacks:removeImage'),
  setPackText: invoke('texturepacks:setText'),
  removePackText: invoke('texturepacks:removeText'),
  downloadOriginal: invoke('texturepacks:downloadOriginal'),
  exportPack: invoke('texturepacks:export'),
  importPack: invoke('texturepacks:import'),
  openPackFolder: invoke('texturepacks:openFolder'),
