...
(with a backup), and installs mods from the community registry with one
click. Every listing shows its GitHub download count and a popularity badge,
with no analytics service anywhere.
